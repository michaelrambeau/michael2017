const history = [
  {
    ...
    resp:
      'Development and maintenance of [shipandco.com](https://www.shipandco.com), a web application built on top of [Meteor](https://www.meteor.com/)',
    points: [
  ...
  },
  {
    ...
    location: 'Osaka, Japan',
    resp:
      'In charge of the [brastelremit.jp](http://brastelremit.jp) web site, a money transfer service from Japan to locations overseas that was launched in March 2012.',
    points: [
