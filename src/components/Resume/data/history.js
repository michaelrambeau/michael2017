const history = [
  {
    ...
    resp: 'Development of shipandco.com web application',
    points: [
      'Development and maintenance of [shipandco.com](https://www.shipandco.com), a new web application built from Meteor platform (node.js technology)',
